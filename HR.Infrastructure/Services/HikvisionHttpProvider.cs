...
public class HikvisionHttpProvider : IAttendanceProvider
{
    public DeviceProtocol SupportedProtocol => DeviceProtocol.HikvisionHttp;

    public Task<List<AttendanceLogDto>> FetchLogsAsync(string deviceIp, CancellationToken cancellationToken)
    {
        throw new NotImplementedException("HTTP Protocol for Hikvision devices is pending implementation.");
    }
