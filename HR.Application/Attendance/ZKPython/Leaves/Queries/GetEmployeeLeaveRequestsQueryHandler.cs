...
{
    public class GetEmployeeLeaveRequestsQueryHandler : IRequestHandler<GetEmployeeLeaveRequestsQuery, IEnumerable<LeaveRequestResponseDto>>
    {
        private readonly ILeaveRepository _leaveRepository;

        public GetEmployeeLeaveRequestsQueryHandler(ILeaveRepository leaveRepository)
        {
